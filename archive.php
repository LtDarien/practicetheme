<?php get_header( );?>
	...
	<?php if(have_posts()): the_post(); ?>
		...
		<?php elseif(is_month()): ?>
			<hi>Archive for <?php the_time('F, Y' );?></hi>
	...
	<?php else: ?>
		<?php if(is_category( )):?>
			<h1>Sorry, but they're arent'y any posts in the <?php single_cat_title( );?> category yet.</h1>
		<?php elseif(is_date()): ?>
			<h1>Sorry, but they're arent'y any posts with this date</h1>
		<?php elseif(is_author( )): ?>
